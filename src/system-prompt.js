...
- KONSISTENZ: Mische niemals unterschiedliche API-Stile in einer Antwort. Entscheide dich für den aktuellen, in der API-Referenz dokumentierten Stil und bleib dabei. Wenn du unsicher bist, prüfe die passende API Referenz mit den Tools.
